										...
										<table class="table">
											...
											<tbody>
												<tr>
													<td>
														<div class="sh_tab_compare_img">
															<img src="{{env('APP_URL')}}assets/images/comapre_store/otto.png">
															<p>1212454 Reviews</p>
														</div>
													</td>
													<td>
												...
												<tr>
													<td>
														<div class="sh_tab_compare_img">
															<img src="{{env('APP_URL')}}assets/images/comapre_store/saturn.png">
															<p>Now Yet Rated</p>
														</div>
													</td>
													<td>
												...
												<tr>
													<td>
														<div class="sh_tab_compare_img">
															<img src="{{env('APP_URL')}}assets/images/comapre_store/galaxus.png">
															<p>555 Reviews</p>
														</div>
													</td>
													<td>
												...
												<tr>
													...
													<td>
														<div class="sh_tab_compare_total_price">
															<h4>$ 7999,00</h4>
															<a class="sh_shop_less_btn" href="javacript:void(0)">To The Shop <i class="icofont-rounded-right"></i></a>
														</div>
													</td>
												</tr>
												<tr>
