				...
				<div class="col-lg-8 col-md-8 col-sm-9 col-xs-12 pull-left">
					<div class="sh_main_menu_wrapper sh_float_width">
						<nav class="sh_main_menu sh_float_width" id="menu">
							<ul>                       
								<li><a class="active" href="javacript:void(0)">Home</a></li>
								<li><a href="javacript:void(0)">Computers</a></li>
								<li><a href="javacript:void(0)">Electronics</a></li>
								<li><a href="javacript:void(0)">Beauty</a></li>
								<li><a href="javacript:void(0)">Dresses</a></li>
								<li><a href="javacript:void(0)">Kids</a></li>
								<li><a href="javacript:void(0)">See All Categories</a></li>
							</ul> 
						</nav>
					</div>
				</div>
				...
				<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
					<div class="sh_widgets sh_float_width">
						...
						<ul>
							...
							<li><a href="javacript:void(0)">Privacy Policy</a></li>
							<li><a href="javacript:void(0)">Terms of Use</a></li>
						</ul>
					</div>
				</div>
			</div>
