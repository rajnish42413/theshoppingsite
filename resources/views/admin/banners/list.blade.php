...
@section('content')
  ...
  <div class="content-wrapper">
    ...
    <form action="searchajaxbanners" method="post" id="bannersfrm">
      {{csrf_field()}}
	<div class="row">
      ...
      <div class="row">
		...
		<a id="top_hotel_delete_btn" class="btn btn-danger btn-sm"  onclick="delete_row('bannersTable','banners-delete')" ><i class="fa fa-trash"></i> Delete</a>			
		</div>		
	  </div>
	  <div class="row">
        <div class="col-lg-12">
        <div class="dt-responsive table-responsive">
            <input type="text" value="" id="checked_ids" style="display:none">
                <table id="bannersTable" class="table table-striped table-bordered display nowrap" >
                    <thead>
                        <tr>
