  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo env('APP_URL');?>parent-categories-list"><?php echo $data['title'];?></a></li>
    ...
    <form action="searchajaxparentcategories" method="post" id="parentcategoriesfrm">
      {{csrf_field()}}
	<div class="row margin">
      ...
      <div class="row">
		...
		<a id="categories_delete_btn" class="btn btn-danger btn-sm"  onclick="delete_row('parentcategoriesTable','categories-delete')" ><i class="fa fa-trash"></i> Delete</a>			
		</div>		
	  </div>
	  <div class="row">
        <div class="col-lg-12">
        <div class="dt-responsive table-responsive">
            <input type="text" value="" id="checked_ids" style="display:none">
                <table id="parentcategoriesTable" class="table table-striped table-bordered display nowrap" >
                    <thead>
                        <tr>
